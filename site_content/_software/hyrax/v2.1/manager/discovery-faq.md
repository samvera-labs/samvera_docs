...
Whether a collection can be set to discoverable is determined by the collection type.  The site admin configures a collection type to have DISCOVERY on/off.
